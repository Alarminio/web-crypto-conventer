...
def api(cryptoFrom, cryptoTo):
    ...
    url= "https://rest.coinapi.io/v1/exchangerate/{}/{}?&apikey={}".format(cryptoTo, cryptoFrom, API_KEY)
...
def ApiErrors(codigo):
    if codigo == 1001:
        msg = "La API KEY es incorrecta o no es válida"
    elif codigo == 1002:
        msg= "No existe ninguna API KEY"
    elif codigo == 1003:
        msg= "La API KEY no está activada"
    elif codigo == 1004:
        msg= "La API KEY ha caducado"
    elif codigo == 1005:
        msg= "Se necesita una API KEY"
    elif codigo == 1006:
        msg= "API KEY no válida para esta operación"
    elif codigo == 1007:
        msg= "API KEY deshabilitada"
    elif codigo == 1008:
        msg= "Se ha superado el límite de velocidad de solicitud HTTP de la API KEY"
    elif codigo == 1009:
        msg= "Se ha superado el límite de tarifa diaria de API KEY"
    elif codigo == 1010:
        msg= "Se ha superado el límite de tarifa mensual de API KEY"
    elif codigo == 1011:
